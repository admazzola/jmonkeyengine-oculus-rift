...
public class Hmd extends Structure {
  ...
  static private FovPort.ByValue byValue(FovPort fov) {
  ...
  static private Posef.ByValue byValue(Posef pose) {
  ...
  static private OvrMatrix4f.ByValue byValue(OvrMatrix4f m) {
  ...
  static private OvrVector2f.ByValue byValue(OvrVector2f v) {
  ...
  static private OvrSizei.ByValue byValue(OvrSizei v) {
  ...
  static private OvrRecti.ByValue byValue(OvrRecti v) {
 ...
 //   Preconditions.checkArgument(secondCalc.equals(secondActual),  "array must be contiguous in memory.");
  }
